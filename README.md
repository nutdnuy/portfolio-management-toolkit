...
- Portfolio Insurance: บทเรียน 13 หัวข้อแบบละเอียด ไล่จาก Put และงบ OBPI สู่ CPPI หลายรอบ, TIPP แบบ Ratchet, Gap risk พร้อมดอกเบี้ย, EUT/CPT พร้อมคำนวณคะแนน และการประเมิน Shortfall/Drawdown มีโจทย์พร้อมเฉลย 8 ข้อและเครื่องมือทดลองในบท
- อภิธานศัพท์: 34 คำพร้อมนิยามภาษาไทย ค้นหาคำ และลิงก์กลับไปยังตัวอย่าง
