...
ในแต่ละตัวอย่าง ให้ลองหามูลค่ารวมก่อนหา Cushion และแยกเงินที่ถืออยู่ก่อนซื้อขายออกจากเป้าหมายหลังซื้อขาย ตารางในบทกับเซลล์ Python ใน Notebook ใช้ตัวเลขเดียวกัน จึงตรวจเหตุผลและคำนวณซ้ำได้ทีละส่วน
...
สิ่งที่ซื้อด้วย Premium คือการเปลี่ยนรูปผลลัพธ์ด้านขาลง โดยต้นทุนนี้ทำให้ต้องรอการขึ้นมากกว่าเดิมก่อนจะคุ้มทุน การที่ Put หมดอายุโดยไม่มี Payoff จึงยังไม่พอจะตัดสินว่าการซื้อสิทธิตั้งแต่ต้นไม่มีความหมาย ต้องอ่านคู่กับผลลัพธ์ด้านขาลงที่ผู้ซื้อเลือกป้องกันด้วย
...
การพิสูจน์ข้างต้นเป็นการขยายเชิงคณิตศาสตร์เพื่ออธิบายคำกล่าวในต้นฉบับ ไม่ใช่การคัดสมการหรือผลการทดลองของวิทยานิพนธ์มาเป็นผลของเครื่องมือ
...
CPPI แบบ Floor ปลายทางคงที่ตั้งเป้าจากเงินเริ่มต้น หากพอร์ตโตจาก 100 เป็น 120 แล้วลดกลับลงมา เป้าหมายเดิมอาจยังอยู่ที่ 90 การเหลือ 95 จึงอาจผ่านเป้าหมายเดิม แต่ลดลงจากจุดสูงสุดไปมากกว่า 20% ผู้ลงทุนที่มองกำไรระหว่างทางเป็นเงินที่อยากรักษาไว้ด้วยกำลังตั้งโจทย์อีกแบบหนึ่ง
...
จึงต้องแยกสามชั้น: กฎต้องการปกป้องเท่าไร กฎให้ถือสินทรัพย์เท่าไร และการซื้อขายทำได้จริงตามกฎหรือไม่ ชื่อ Time Invariant ก็ไม่ได้ทำให้ระยะเวลา รอบสังเกต และรอบซื้อขายหมดความสำคัญ
...
การขายหลังขึ้นในตัวอย่างนี้ต่างจาก CPPI ที่มี $m>1$ และยังไม่ติดเพดาน: CPPI เพิ่มเงินเสี่ยงเมื่อ Cushion ขยาย สิ่งที่ใช้กำหนดเงินเสี่ยงคนละอย่างจึงทำให้ทิศทางการปรับต่างกัน
...
การเลือกกลยุทธ์มีคำถามอย่างน้อยสองข้อ: **กลยุทธ์สร้างผลลัพธ์อะไรได้บ้าง** และ **ผู้ลงทุนให้คุณค่ากับผลลัพธ์เหล่านั้นอย่างไร** ข้อแรกเกี่ยวกับราคาและการจัดพอร์ต ข้อที่สองเกี่ยวกับความชอบ ความมั่งคั่ง และสิ่งที่ถือว่าเป็นการขาดทุน วิทยานิพนธ์จึงนำการกระจายผลลัพธ์มาประเมินผ่านทั้ง EUT และ CPT
...
ถ้า $U$ เพิ่มขึ้นแต่โค้งเว้า หรือ **Concave** ประโยชน์ส่วนเพิ่มของเงินจะลดลงเมื่อความมั่งคั่งสูงขึ้น นี่เป็นรูปแบบของ **[Risk aversion](glossary.html#risk-aversion)** ใน EUT ผู้ลงทุนให้คุณค่าแก่เงินแน่นอนเท่าค่าเฉลี่ยของทางเลือกเสี่ยงไม่น้อยกว่าทางเลือกเสี่ยงนั้น ถ้า Utility โค้งเว้าอย่างเคร่งครัดและผลลัพธ์มีความเสี่ยงจริง ความชอบจึงมากกว่าอย่างเคร่งครัด เงื่อนไขสำคัญคือเทียบกับเงินแน่นอน **ที่มีค่าเท่ากันกับค่าเฉลี่ย** ไม่ได้หมายความว่าผู้หลีกเลี่ยงความเสี่ยงต้องปฏิเสธสินทรัพย์เสี่ยงทุกชนิด
...
CPT ไม่เพียงเปลี่ยนคะแนนของจำนวนเงิน แต่ยังใช้ **[Probability weighting](glossary.html#probability-weighting)** เพื่อให้เหตุการณ์บางขนาดความน่าจะเป็นมีน้ำหนักในการตัดสินใจต่างจากโอกาสเกิดจริง งานใช้ฟังก์ชัน
...
EUT และ CPT ทำให้เห็นว่าเราต้องรู้มากกว่าคำตอบว่า “อยากได้ผลตอบแทนสูงไหม” การรู้ว่าผู้ลงทุนให้คุณค่ากับความคุ้มครองเพียงใด มีเงินที่ต้องใช้เมื่อไร และถืออะไรเป็นการขาดทุน ล้วนเปลี่ยนวิธีเลือกพอร์ตได้ บท 6 จึงตรวจอีกขั้นของกระบวนการ: **แบบสอบถามแปลงความต้องการเหล่านั้นเป็นพอร์ตได้สอดคล้องกันเพียงใด**
...
ผลนี้ยังไม่ได้จัดอันดับพอร์ตให้ทุกคน A มีขาขึ้นสูงกว่าในกรณีที่ 5 ด้วย ผู้ประเมินต้องบอกว่าจะให้คุณค่าแก่ความเสียหายส่วนลึกกับโอกาสขาขึ้นอย่างไร จึงเชื่อมกลับไปสู่ EUT และ CPT ในหัวข้อก่อนหน้า
...
เมื่ออธิบายประเด็นเหล่านี้ได้ การอ่านผลวิจัยก็จะตรงขึ้น: **คุณค่าของ Portfolio Insurance ขึ้นกับสิ่งที่ต้องการป้องกัน สิ่งที่ยอมแลก และเงื่อนไขที่ทำให้กลไกทำงาน** ผลภายใต้แบบจำลองหนึ่งช่วยให้เข้าใจเหตุผล แต่ยังต้องอ่านพร้อมต้นทุนและข้อจำกัดของแบบจำลองนั้น
