...
เริ่มจาก **[How to Calculate return](returns.html)** เพื่อทำความเข้าใจ Simple return และ Log return การทบต้น ค่าเฉลี่ย และการรวมผลตอบแทนของพอร์ต พร้อมตัวอย่างคำนวณและ [Notebook ของบท Return](notebooks/returns.ipynb)
