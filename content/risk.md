...
<p class="lead">เมื่อยังไม่รู้เงินปลายทาง เราจะอธิบาย วัด และตัดสินใจเรื่องความเสี่ยงอย่างไร</p>
...
ต่อจาก[บทผลตอบแทน](returns.html) เราจะเริ่มจากความหมายและที่มาของความเสี่ยง แล้วจึงใช้ตัวอย่างเดียวกันเปรียบเทียบตัววัดหลายแบบ

เวลาคำนวณผลตอบแทนย้อนหลัง เรารู้แล้วว่าเงินเริ่มต้นและเงินปลายทางเท่าไร แต่ในวันที่ตัดสินใจลงทุน เงินปลายทางยังไม่เกิดขึ้น เราจึงต้องตัดสินใจจากผลลัพธ์หลายแบบที่อาจเกิดขึ้น รวมถึงผลลัพธ์ที่ไม่ต้องการ

นี่คือจุดเริ่มต้นของความเสี่ยงในการลงทุน การคำนวณผลตอบแทนช่วยบอกว่าเงินเปลี่ยนไปเท่าไร ส่วนการวิเคราะห์ความเสี่ยงช่วยให้พิจารณาความไม่แน่นอนของผลลัพธ์ ขนาดความเสียหาย และความสัมพันธ์ระหว่างสินทรัพย์ก่อนตัดสินใจจัดพอร์ต
